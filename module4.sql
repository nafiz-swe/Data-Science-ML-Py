...
Ans: 
Select * from google_salaries where salary > 5000;
...
Ans: 
Select distinct first_name, department, education from google_salaries where first_name like 'Ma%'
...
Select education, sum(salary) from google_salaries group by education;
